...
namespace ERPSample.Controllers.Inventory.Transactions
{
    public class SalesEstimateController : BaseController
    {
        ...
        public SalesEstimateController(
            ...
            IHubContext<ProgressHub> hub)
        {
            ...
            _menuRow = new Lazy<DataRow>(() => _dalMenu.Value.LoadWindowsForm(261).Rows[0]);
            _voucherTypeRow = new Lazy<DataRow>(() => _dalVouchers.Value.FillVoucherRow(261, _menuRow.Value["ID"]));
        }
        ...
        public async Task<IActionResult> Index(long MenuID)
        {
            ...
            return View("~/Views/Invertory/Transactions/SalesEstimate.cshtml");
        }
        ...
        public async Task<IActionResult> InsertTransaction([FromBody] SaveTransactionEntryRequest request)
        {
            try
            {
                ...
                request.FiTransactions.PageID = (int)PageIDs.SalesEstimate;
