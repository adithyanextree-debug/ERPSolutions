...
namespace ERPSample.Controllers.Inventory.Transactions
{
    public class SalesEnquiryController : BaseController
    {
            ...
            IHubContext<ProgressHub> hub)
        {
            ...
            _menuRow = new Lazy<DataRow>(() => _dalMenu.Value.LoadWindowsForm(232).Rows[0]);
            _voucherTypeRow = new Lazy<DataRow>(() => _dalVouchers.Value.FillVoucherRow(232, _menuRow.Value["ID"]));
        }
        ...
        public async Task<IActionResult> Index(long MenuID)
        {
            ...
            return View("~/Views/Invertory/Transactions/SalesEnquiry.cshtml");
        }
        ...
        public async Task<IActionResult> InsertTransaction([FromBody] SaveTransactionEntryRequest request)
        {
            try
            {
                ...
                request.FiTransactions.PageID = (int)PageIDs.SalesEnquiry;
