...
namespace ERPSample.Controllers.Inventory.Transactions
{
    public class OpeningStockController : BaseController
    {
        ...
        public override void OnActionExecuting(ActionExecutingContext context)
        {
            ...
            _MenuRow = new Lazy<DataRow>(() => DALMenu.LoadWindowsForm(135).Rows[0]);
            _VoucherTypeRow = new Lazy<DataRow>(() => DALVouchers.FillVoucherRow(135, MenuRow["ID"]));
        }
        ...
        public async Task<IActionResult> Index(long MenuID)
        {
            ...
            return View("~/Views/Invertory/Transactions/OpeningStock.cshtml");// Json(new { itemmaster = itemmaster, success = true});
        }
        ...
        public async Task<IActionResult> InsertTransaction([FromBody] SaveTransactionEntryRequest request)
        {
            try
            {
                ...
                request.FiTransactions.PageID = (int)PageIDs.OpeningStock;
