...
namespace ERPSample.Controllers.Inventory.Transactions
{
    public class DeliveryInController : BaseController
    {
        ...
        public override void OnActionExecuting(ActionExecutingContext context)
        {
            ...
            _MenuRow = new Lazy<DataRow>(() => DALMenu.LoadWindowsForm(234).Rows[0]);
            _VoucherTypeRow = new Lazy<DataRow>(() => DALVouchers.FillVoucherRow(234, MenuRow["ID"]));
        }
        ...
        public async Task<IActionResult> Index(long MenuID)
        {
            ...
            return View("~/Views/Invertory/Transactions/DeliveryIn.cshtml");
        }
        ...
        public async Task<IActionResult> InsertTransaction([FromBody] SaveTransactionEntryRequest request)
        {
            try
            {
                ...
                request.FiTransactions.PageID = (int)PageIDs.DeliveryIn;
