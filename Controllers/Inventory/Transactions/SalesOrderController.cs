...
namespace ERPSample.Controllers.Inventory.Transactions
{
    public class SalesOrderController : BaseController
    {
            ...
            IHubContext<ProgressHub> hub)
        {
            ...
            _menuRow = new Lazy<DataRow>(() => _dalMenu.Value.LoadWindowsForm(262).Rows[0]);
            _voucherTypeRow = new Lazy<DataRow>(() => _dalVouchers.Value.FillVoucherRow(262, _menuRow.Value["ID"]));
        }
        ...
        public async Task<IActionResult> Index(long MenuID)
        {
            ...
            return View("~/Views/Invertory/Transactions/SalesOrder.cshtml");
        }
        ...
        public async Task<IActionResult> InsertTransaction([FromBody] SaveTransactionEntryRequest request)
        {
            try
            {
                ...
                request.FiTransactions.PageID = (int)PageIDs.SalesOrder;
