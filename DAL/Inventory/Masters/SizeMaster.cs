...
namespace ERPSample.DAL.Inventory.Masters
{
    public class SizeMaster
    {
        ...
        public SizeMaster(String ConnectionString = "")
        {
        ...
        {
            SqlCommand Cmd = new SqlCommand("MaMiscSizeMasterSP", new SqlConnection(ConnectionString));
        ...
        public int CheckDuplicateEntry(string Value)
        {
            try
            {
                ...
                Cmd.Connection.Open();
                Cmd.CommandText = "SELECT Count(*) As Count FROM MaMisc WHERE [Key]='Item Size' and Value=@Value";
        ...
        public string InsertSizeMaster(MaMisc ma, SqlConnection Conn, SqlTransaction Tx)
        {
            try
            {
                ...
                {
                    Cmd.Parameters.AddWithValue("@Key", "Item Size");
                }
                Cmd.Connection.Open();
        ...
        public int DeleteSizeMaster(int ID)
        {
            try
            {
                SqlCommand Cmd = new SqlCommand("MaMiscSizeMasterSP", new SqlConnection(ConnectionString));
