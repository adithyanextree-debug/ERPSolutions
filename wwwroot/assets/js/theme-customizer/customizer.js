(function ($) {
    ...
    $(document).ready(function () {
        ...
        const cogClick = document.getElementById("cog-click");
        const cogClose = document.getElementById("cog-close");
        const settingSidebar = document.querySelector(".setting-sidebar");

        if (cogClick && settingSidebar) {
            cogClick.addEventListener("click", function () {
                settingSidebar.classList.add("open");
            });
        }

        if (cogClose && settingSidebar) {
        ...
        /* ================= LTR / RTL / BOX ================= */
        const ltr = document.querySelector(".ltr-setting");
        if (ltr) {
        ...
        const rtl = document.querySelector(".rtl-setting");
        if (rtl) {
        ...
        const box = document.querySelector(".box-setting");
        if (box) {
        ...
        /* ================= COLORFULL SVG ================= */
        const colorSvg = document.querySelector(".colorfull-svg");
        const pageSidebar = document.querySelector(".page-sidebar");

        if (colorSvg && pageSidebar) {
            colorSvg.addEventListener("click", function () {
        ...
        document.querySelectorAll(".default-svg").forEach(function (element) {
            element.addEventListener("click", function () {
                document.querySelectorAll(".page-sidebar").forEach(function (sidebar) {
                    sidebar.setAttribute("data-sidebar-layout", "stroke-svg");
                    sidebar.classList.remove("iconcolor-sidebar");
                });
            });
        });
    ...
    document.addEventListener("DOMContentLoaded", function () {
        const mixSetting = document.querySelector(".mix-setting");

        if (mixSetting) {
            mixSetting.addEventListener("click", function () {
    ...
    if (view.length) {
        ...
        var menuWrapperSize = $(".page-sidebar").innerWidth() || 0;
        var sliderLimit = menuWrapperSize >= 1440 ? -3250 : -4500;

        $("#left-arrow").addClass("disabled");

        $("#right-arrow").on("click", function () {
            var currentPosition = parseInt(view.css("marginLeft")) || 0;
