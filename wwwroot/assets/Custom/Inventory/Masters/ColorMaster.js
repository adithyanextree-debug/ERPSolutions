var webUrl = '/ColourMaster/';
var CommonUrl = '/ColourMaster/';

function NewEntry() {
    $("#Active").prop('checked', true);
    $(".form-control").val('').trigger("change");
    $("#ColorMasterList").hide();
    $("#ColorMasterForm").show();
    $("#Value").focus();
    //$.ajax({
    //    url: webUrl + "NewEntry",
    //    method: "POST",
        ...
        success: function (data) {
            ...
            if (data.success) {
                Swal.fire({
                    ...
                    window.location.href = "/ColourMaster/Index?MenuID=" + menuId;
                });
