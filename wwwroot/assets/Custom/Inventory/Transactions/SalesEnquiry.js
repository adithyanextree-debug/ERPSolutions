var webUrl = '/SalesEnquiry/';
var CommonUrl = '/CommonFunctions/';

function NewEntry() {
    $("#SalesEnquiryList").hide();
    $("#SalesEnquiryForm").show();
    $.ajax({
...
$(document).on("click", ".addrow", function (event) {
    ...
    $.ajax({
        ...
        // url: "/SalesEnquiry/NewRow?no=" + serialno,
        method: "GET",
        dataType: 'JSON',
        success: function (data) {
        ...
        success: function (data) {
            ...
            if (data.success) {
                Swal.fire({
                    ...
                    window.location.href = "/SalesEnquiry/Index?MenuID=" + menuId;
                });
