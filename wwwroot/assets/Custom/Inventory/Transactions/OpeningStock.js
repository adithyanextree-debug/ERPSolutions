var webUrl = '/OpeningStock/';
var CommonUrl = '/CommonFunctions/';

function NewEntry() {
    $("#OpeningStockList").hide();
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            var parts = data.voucherDate.split('-');
            ...
            $("#VoucherDate").val(formattedDate).prop("disabled", true);
...
$(document).on("click", ".addrow", function (event) {
    ...
    $.ajax({
        ...
        // url: "/OpeningStock/NewRowStockItems?no=" + serialno,
        method: "GET",
        dataType: 'JSON',
        success: function (data) {
        ...
        success: function (data) {
            ...
            if (data.success) {
                Swal.fire({
                    ...
                    window.location.href = "/OpeningStock/Index?MenuID=" + menuId;
                });
    ...
    $.ajax({
        ...
        success: function (data) {
            if (data['success'] == true) {
                ...
                $("#VoucherDate").val(formatDate(transaction.Date)).prop("disabled", true);
...
$(document).on("input", ".ItemQty, .ItemTaxPer, .ItemTaxAmt", function () {
